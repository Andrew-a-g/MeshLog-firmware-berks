...
4. Run the unit tests, all seven PlatformIO builds, packaging, and `sha256sum --check SHA256SUMS`. Confirm `SHA256SUMS` covers `manifest.json` and keep the complete logs. Use a new output path; candidate directories are immutable.
